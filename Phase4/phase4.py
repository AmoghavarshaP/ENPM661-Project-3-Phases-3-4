...
sim.simxFinish(-1)
clientID = sim.simxStart('127.0.0.1', 19997, True, True, 1700, 5)
sim.simxStopSimulation(clientID, sim.simx_opmode_oneshot_wait)

errorCode, bot_handle = sim.simxGetObjectHandle(clientID, 'Turtlebot2',sim.simx_opmode_oneshot_wait)
...
if parent is not None:
    ...
    errorCode, left_motor_handle = sim.simxGetObjectHandle(clientID, 'wheel_left_joint', sim.simx_opmode_oneshot_wait)
    errorCode, right_motor_handle = sim.simxGetObjectHandle(clientID, 'wheel_right_joint',
    ...
    for g in (range(len(Data))):
        ...
        errorCode = sim.simxSetJointTargetVelocity(clientID, left_motor_handle, Vel_Left/5, sim.simx_opmode_streaming)
        errorCode = sim.simxSetJointTargetVelocity(clientID, right_motor_handle, Vel_Right/5, sim.simx_opmode_streaming)
    ...
    Vel_Left = 0
    Vel_Right = 0
    errorCode = sim.simxSetJointTargetVelocity(clientID, left_motor_handle, Vel_Left, sim.simx_opmode_streaming)
    errorCode = sim.simxSetJointTargetVelocity(clientID, right_motor_handle, Vel_Right, sim.simx_opmode_streaming)
